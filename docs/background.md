...
> Synthèse condensée de la phase de recherche préparatoire (juillet 2026). Notes brutes et bibliographies complètes (~100 URLs annotées) dans `research/raw/`. ⚠️ = référence remontée par un agent de recherche automatique, à revérifier à la main avant citation dans le papier.
...
1. Kulveit et al., *Gradual Disempowerment* (2025) — arxiv.org/abs/2501.16946
2. Drago & Laine, *The Intelligence Curse* (2025) — intelligence-curse.ai
3. Critch, *What Multipolar Failure Looks Like (RAAPs)* (2021) — Alignment Forum
4. Christiano, *What Failure Looks Like* (2019) — Alignment Forum
5. Hammond et al., *Multi-Agent Risks from Advanced AI* (2025) — arxiv.org/abs/2502.14143
6. Grossman & Stiglitz, *On the Impossibility of Informationally Efficient Markets* (1980)
7. Korinek (NBER 2024-2025), scénarios de transition AGI — korinek.com
8. Shalizi, *The Platform Socialist Calculation Problem* (2022) ; Brynjolfsson & Hitzig, *AI's Use of Knowledge in Society* (2025) ⚠️
9. De Loecker & Eeckhout, *Global Market Power*
10. Armstrong, Bostrom & Shulman, *Racing to the Precipice* (2016)
